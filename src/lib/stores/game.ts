...
/**
 * If enabled, balls will be dropped following a preselected L/R path to reach this bin index.
 */
export const preselectedBinIndex = writable<number>(0);

/**
 * Toggle to use preselected bin when dropping balls from UI.
 */
export const isPreselectEnabled = writable<boolean>(false);
